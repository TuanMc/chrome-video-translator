...
• **Mob Elaboration**: When `.aidlc/aidlc-agents/` exists, Inception runs a Mob Elaboration ritual that applies those specialist agent personas before Construction; see `inception/mob-elaboration.md`
