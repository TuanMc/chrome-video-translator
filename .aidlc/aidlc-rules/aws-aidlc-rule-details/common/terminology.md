...
- Mob Elaboration (ALWAYS when `.aidlc/aidlc-agents/` exists)
...
### Mob Elaboration
**Purpose**: Collaborative Inception ritual that applies project specialist agents from `.aidlc/aidlc-agents/` to elaborate intent into validated requirements, NFRs, technical direction, and documentation plans before Construction.  
**Rules**: `inception/mob-elaboration.md`  
**Agents path**: `.aidlc/aidlc-agents/*.md`  
**Outputs**: `aidlc-docs/inception/mob-elaboration/` (per-agent artifacts + `session-summary.md`)  
**Constraint**: No application source-code changes during Mob Elaboration
