...
2. **If project agents exist** under `.aidlc/aidlc-agents/`, **I'll run Mob Elaboration** with those specialist roles (Business Analyst, Frontend Architect, Accessibility Specialist, Performance Engineer, Technical Writer, plus any others present) — no application code changes during that ritual
