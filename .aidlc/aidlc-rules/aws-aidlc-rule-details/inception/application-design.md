...
- **IF present**, also read `aidlc-docs/inception/mob-elaboration/session-summary.md` and especially `frontend-architect.md`, `accessibility-specialist.md`, and `performance-engineer.md`
- Identify key business capabilities and functional areas
- Determine design scope and complexity
- Prefer Mob Elaboration Frontend Architect boundaries/reuse guidance when available; log conflicts instead of silently overriding
