...
Byte-identical to libre-server/app/models/protocol.py and nllb-server's
equivalent — this is the extension-facing contract, intentionally duplicated
per AGENTS.md's documented convention rather than shared.
"""
